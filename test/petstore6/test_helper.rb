...
class Petstore6::Test::SingletonClient < Petstore6::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Petstore6::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Petstore6::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @petstore6 = Petstore6::Test::SingletonClient.instance
  end
