...
class Petstore6::Test::PrimitiveModelTest < Minitest::Test
  A = Petstore6::Internal::Type::ArrayOf[-> { Integer }]
  H = Petstore6::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend Petstore6::Internal::Type::Union
  end

  class B < Petstore6::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Petstore6::Internal::Type::Unknown,
      Petstore6::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Petstore6::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Petstore6::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Petstore6::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Petstore6::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Petstore6::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Petstore6::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Petstore6::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Petstore6::Internal::Type::Boolean, true] => true,
      [Petstore6::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Petstore6::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Petstore6::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Petstore6::Internal::Type::Converter.new_coerce_state
      Petstore6::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Petstore6::Internal::Type::Converter.dump(target, input, state: state)
...
class Petstore6::Test::EnumModelTest < Minitest::Test
  class E0
    include Petstore6::Internal::Type::Enum
...
class Petstore6::Test::CollectionModelTest < Minitest::Test
  A1 = Petstore6::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Petstore6::Internal::Type::HashOf[Integer]

  A2 = Petstore6::Internal::Type::ArrayOf[H1]
  H2 = Petstore6::Internal::Type::HashOf[-> { A1 }]

  A3 = Petstore6::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Petstore6::Internal::Type::HashOf[Integer, nil?: true]
...
class Petstore6::Test::BaseModelTest < Minitest::Test
  class M1 < Petstore6::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Petstore6::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Petstore6::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Petstore6::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Petstore6::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Petstore6::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Petstore6::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Petstore6::Errors::ConversionError => e
...
class Petstore6::Test::UnionTest < Minitest::Test
  class U0
    include Petstore6::Internal::Type::Union
  ...
  class M2 < Petstore6::Internal::Type::BaseModel
  ...
  class M4 < Petstore6::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Petstore6::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Petstore6::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Petstore6::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Petstore6::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Petstore6::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Petstore6::Internal::Type::Unknown, Petstore6::Internal::Type::Unknown] => true,
      [Petstore6::Internal::Type::Boolean, Petstore6::Internal::Type::Boolean] => true,
      [Petstore6::Internal::Type::Unknown, Petstore6::Internal::Type::Boolean] => false,
...
class Petstore6::Test::MetaInfoTest < Minitest::Test
  A1 = Petstore6::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Petstore6::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
