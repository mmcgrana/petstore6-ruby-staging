...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/petstore6/helpers/` and `examples/` directory.
...
require_relative "../lib/petstore6"
...
```ruby
gem "petstore6", git: "https://github.com/stainless-sdks/petstore6-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://github.com/stainless-sdks/petstore6-ruby' '<path-to-repo>'
```

```ruby
gem "petstore6", path: "<path-to-repo>"
```
